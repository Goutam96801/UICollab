            ...
            <div className="mt-4 bg-gray-700 p-4 rounded-xl">
              ...
              <div className="space-y-2">
                <div className="relative flex rounded-lg">
                  ...
                  />
                  <label className=" font-semibold absolute top-1/2 translate-y-[-50%] peer-focus:bg-transparent left-4 peer-focus:top-0 opacity-70 peer-focus:left-3 text-base peer-focus:text-sm peer-focus:text-[#fff] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm  duration-150" htmlFor="label">
                    Label
                  </label>
                </div>
                <div>
                  ...
                  <AnimationWrapper transition={0.1}>
                    <div className="flex flex-col gap-4">
                      <div className="relative flex rounded-lg">
                        ...
                        />
                        <label className=" font-semibold absolute top-1/2 opacity-70 translate-y-[-50%] peer-focus:bg-transparent left-4 peer-focus:top-0 peer-focus:left-3 text-base peer-focus:text-sm peer-focus:text-[#fff] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm duration-150" htmlFor="sourceLink">
                          Link to the source
                        </label>
                      </div>
                      ...
                      <div className="relative flex rounded-lg">
                        ...
                        />
                        <label className=" font-semibold absolute top-1/2 opacity-70 translate-y-[-50%] peer-focus:bg-transparent left-4 peer-focus:top-0 peer-focus:left-3 text-base peer-focus:text-sm peer-focus:text-[#fff] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm  duration-150" htmlFor="sourceCreator">
